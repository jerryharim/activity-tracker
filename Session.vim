...
nnoremap  :FZF
nmap  :bp:bd #
map  :YcmCompleter GoToReferences
...
map <C-[> :YcmCompleter GoToReferences
map <C-]> :YcmCompleter GoTo
map <F4> :YcmDiags
map <F1> :YcmCompleter FixIt
...
set pyxversion=3
set ruler
set runtimepath=~/.vim,~/.vim/plugged/vim-es2015-snippets,~/.vim/plugged/indentLine,~/.vim/plugged/vim-airline,~/.vim/plugged/vim-airline-themes,~/.vim/plugged/vim-fugitive,~/.vim/plugged/vim-gitgutter,~/.vim/plugged/powerline/powerline/bindings/vim,~/.vim/plugged/vim-devicons,~/.vim/plugged/vim-tmux,~/.vim/plugged/vim-tmux-navigator,~/.vim/plugged/tcomment_vim,~/.vim/plugged/colorizer,~/.vim/plugged/gruvbox-material,~/.vim/plugged/vim-javacomplete2,~/.vim/plugged/nvim-yarp,~/.vim/pack/vendor/start/vim-javacomplete2,~/.vim/pack/vendor/start/java_getset.vim,~/.vim/pack/vendor/start/JavaImp,~/.vim/pack/bundle/start/youcompleteme,~/.vim/pack/bundle/start/vim-lsc,~/.vim/pack/bundle/start/fzf.vim,~/.vim/pack/bundle/start/eclim,~/.vim/pack/bundle/start/JavaImp.vim,/usr/share/vim/vimfiles,/usr/share/vim/vim82,~/.vim/pack/bundle/start/vim-lsc/after,/usr/share/vim/vimfiles/after,~/.vim/plugged/indentLine/after,~/.vim/after
set shiftwidth=4
set showbreak=↳\ 
...
tabnew
tabrewind
edit activity-tracker-core/src/test/java/mg/jerryharim/activitytracker/core/stepdefs/EnregistrementActiviteStepDefs.java
...
silent! normal! zE
let &fdl = &fdl
let s:l = 40 - ((30 * winheight(0) + 20) / 41)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 40
normal! 09|
lcd ~/workspace/envMaven/projects/activity-tracker/activity-tracker-core
tabnext
edit ~/.vimrc
set splitbelow splitright
set nosplitbelow
...
tabnext 1
set stal=1
badd +1 ~/workspace/envMaven/projects/activity-tracker/pom.xml
badd +1 ~/.vimrc
badd +1 ~/workspace/envMaven/projects/activity-tracker
badd +22 ~/workspace/envMaven/projects/activity-tracker/activity-tracker-core/src/test/java/mg/jerryharim/activitytracker/core/stepdefs/EnregistrementActiviteStepDefs.java
badd +1 ~/workspace/envMaven/projects/activity-tracker/activity-tracker-core/src/test/java/mg/jerryharim/activitytracker/core/stepdefs/EnregistrementActivite.java
badd +3 ~/workspace/envMaven/projects/activity-tracker/activity-tracker-core/src/main/java/mg/jerryharim/activitytracker/core/usecase/EnregistrementActivite.java
